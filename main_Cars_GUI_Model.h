...
class CarsGUIModel :public QWidget {
private:
    ...
    QRadioButton* radioSortNrInmatriculare = new QRadioButton(QString::fromStdString("Numar de inmatriculare"));
...
public:
    ...
    CarsGUIModel(CarService& _srv) :srv{ _srv } {
        initGUI();
        connectSignalsSlots();
        dinamicButtons();
    ...
    CarsGUIModel(CarsGUIModel& _gui) = delete;
